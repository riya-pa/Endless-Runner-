...
public class PlatformSpawner : MonoBehaviour
{
    ...
    float timeSinceLastSpawn = 0.0f;  //Tracks the time since we last spanwed something 
    ...
    void Update()
    {
        //Add Time.deltaTime returns the amount of time passed since the the last frame. 
        ...
        if (timeSinceLastSpawn > timeToNextSpawn)
        {
            ...
            //The third parameter is for the rotation, and the Quaternion.idenity means no rotation 
